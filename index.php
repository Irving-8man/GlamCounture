    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/hombre.jpg" alt="slider1">
            ...
            <div class="item">
                <img src="./assets/img/bebe.jpg" alt="bebe">
                <div class="carousel-caption">
                    Ropa para Bebés
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">GLAM COUNTURE</span> en un sencillo formulario para poder completar tus pedidos</p>
